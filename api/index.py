...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "CE031"  # Playfab Title Id
        self.SecretKey: str = "GWMZFQE4KYE757QQFCDHIZN7Y48PCAS63RNDXEHHDHFNEBW56E"  # Playfab Secret Key
        self.ApiKey: str = "OC|1160315490500090|393f8b5bc3d0b900e86d77bb0df13536"  # App Api Key (Oculus/Graph API)
